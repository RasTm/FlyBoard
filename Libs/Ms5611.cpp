...
/**
  ...
  * @retval
  */
void Ms5611::Get_Coefficent(std::vector<uint16_t> &coeff_data){
...
void Ms5611::Get_Raw_Data(uint32_t &raw_pressure, uint32_t &raw_temp){
	...
	write_byte_small(MS_ADDR, d2_selection);		//Pressure Conversion
	delay(11);
...
/**
  ...
  * @retval
  */
void Ms5611::Calculate_Absolute_Val(std::vector<uint16_t> &coeff, double *return_val, double &alt){
